...
public class OwnerService {
  ...
  public Owner createOwner(String email,String password,String name) {
      ...
      if(!email.equals("admin@grocerystore.com")) throw new IllegalArgumentException
  ...
  private boolean passwordIsValid(String password){
    if (password.length()<4) throw new IllegalArgumentException("Password must have at least 4 characters");
