...
public class ShoppableItemController {
	...
	public ResponseEntity<?> createShoppableItem(@RequestParam("name") String name, @RequestParam("price") double price,
			@RequestParam("quantity available") int quantityAvailable) {
	...
	public ShoppableItemDto updatePrice(@PathVariable("name") String name, @RequestParam("newPrice") double newPrice) {
