...
public class LoginController {
	...
	public static CustomerDto convertToCustomerDto(Customer customer) {
		...
		CustomerDto customerDto = new CustomerDto(customer.getEmail(), customer.getPassword(), customer.getName(),
				customer.getAddress());
		return customerDto;
	}
	...
	private EmployeeDto convertToEmployeeDto(Employee employee) {
		...
		EmployeeDto employeeDto = new EmployeeDto(employee.getEmail(), employee.getPassword(), employee.getName(),
				employee.getSalary(),
